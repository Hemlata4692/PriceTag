...
- (void)viewDidLoad
{
    ...
    list = [NSArray arrayWithObjects:@"Earned Money",@"Lowest Submission",@"My Activity",@"Timer",@"Offer Feed",nil];
    
    imageList = [NSArray arrayWithObjects:@"money_icon.png",@"mySubmisson.png",@"my-activity_icon.png",@"timer_icon.png",@"offer_icon.png",nil];
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    if ([[UIDevice currentDevice].systemVersion floatValue]< 8.0) {
        self.dropDownView.frame =CGRectMake(self.view.frame.size.width - 161, 0, 161, 0);

    } else {
        self.dropDownView.frame =CGRectMake(self.view.frame.size.width - 161, 20, 161, 0);
...
//            secList = [NSArray arrayWithObjects:[NSString stringWithFormat:@"%@",[tempDict valueForKey:@"earnedMoney"] ],[NSString stringWithFormat:@"%@",[tempDict valueForKey:@"totalComments"] ],[NSString stringWithFormat:@"%@",[tempDict valueForKey:@"totalActivities"] ],[NSString stringWithFormat:@"%@",[tempDict valueForKey:@"totalOfferTickers"] ],nil];
            secList = [NSArray arrayWithObjects:[NSString stringWithFormat:@"%@",[tempDict valueForKey:@"earnedMoney"] ],[NSString stringWithFormat:@"%@",[tempDict valueForKey:@"totalActivities"] ],[NSString stringWithFormat:@"%@",[tempDict valueForKey:@"totalOfferTickers"] ],nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if (indexPath.row==2)
    {
        ...
        cell.secondTitle.text = [secList objectAtIndex:1];
        cell.imageview.image=[UIImage imageNamed:[imageList objectAtIndex:indexPath.row]];
    }
    else if ((indexPath.row==4))
    {
        cell.arrow.hidden=NO;
        cell.secondTitle.text = [secList objectAtIndex:2];
        cell.imageview.image=[UIImage imageNamed:[imageList objectAtIndex:indexPath.row]];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.row == 1)
    {
        ...
        [UIView animateWithDuration:0.3f animations:^{
            ...
            [self gotoSubmission:(int)indexPath.row];
    ...
    else if(indexPath.row == 2)
    {
        ...
        [UIView animateWithDuration:0.3f animations:^{
            ...
            [self gotoActivity:(int)indexPath.row];
...
#pragma mark - Submission Method
//Action for moving to comments and my activity module
- (void)gotoSubmission:(int)index
{
    UIStoryboard * storyboard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
    HomeViewController * submissionView = [storyboard instantiateViewControllerWithIdentifier:@"HomeViewController"];
//    objCommentsView.screenCounter = index;
    [self.navigationController pushViewController:submissionView animated:YES];
}
#pragma mark - end
...
-(IBAction)myAction:(UIButton *)sender
{
    ...
    if ([RedeemCount isEqualToString:@"RM$0.0"])
    {
