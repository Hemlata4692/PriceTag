...
@synthesize PriceClosedView,NextDay,NextHours,NextMinutes,NextSeconds,todayDate,endingDate,nextStartingDate,Product_ID,lastContentOffset;
//@synthesize myPositionView;
...
//        nextStartingDate=@"2014-10-1512:22:40";
        ...
        for (int i =0; i<tempAry.count; i++)
        {
            ...
            data.noOfEntries = [[tempDict objectForKey:@"total_entries"] intValue];
                 ...
                 cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (data.noOfEntries < 2) {
        myCell.totalEntryLabel.text = [NSString stringWithFormat:@"%d Entry",data.noOfEntries];
    }
    else{
        myCell.totalEntryLabel.text = [NSString stringWithFormat:@"%d Entries",data.noOfEntries];
    }
//    myCell.totalEntryLabel.text = [NSString stringWithFormat:@"%d Entries",data.noOfEntries];
...
didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    objProductDetail.tabChecker = NO;
    DataHolderClass * data = [self.data_array objectAtIndex:indexPath.row];
